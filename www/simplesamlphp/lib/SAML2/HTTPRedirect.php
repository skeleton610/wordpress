...
class SAML2_HTTPRedirect extends SAML2_Binding {
	...
	public function getRedirectURL(SAML2_Message $message) {
        ...
        SimpleSAML_Logger::debug('****************** in  HTTP_REDIRECT redirect url *******************');
        ...
        /*        SimpleSAML_Logger::debugMessage('****** in  HTTP_REDIRECT unsignedXML *****'.$msgStr, 'out'); */

		$msgStr = $msgStr->ownerDocument->saveXML($msgStr);

        /*SimpleSAML_Logger::debugMessage('****** in  HTTP_REDIRECT *****'.$msgStr,'out');*/
